		...
		<div className="flex h-full flex-col bg-neutral-950">
			<div className="relative h-56 shrink-0">
				...
				<button
					type="button"
					onClick={onBack}
					className="absolute left-4 top-4 flex h-8 w-8 items-center justify-center rounded-full bg-black/50 text-xl text-white md:left-8"
					aria-label="Voltar"
				>
					‹
				</button>
			...
			<div className="border-t border-neutral-800 bg-neutral-950 px-4 py-4 md:px-8">
