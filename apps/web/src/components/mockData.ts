...
export const EVENTS: EventItem[] = [
  {
    ...
    description: 'A turnê mais esperada do ano com visual imersivo, luzes e um repertório de grandes sucessos.',
  ...
  },
  {
    ...
    description: 'Uma paisagem épica em IMAX com seleção de assentos e mais de 1.200 lugares para explorar.',
    organizer: 'Cinepolis',
    price: 48,
    seatMap: 'grid',
  ...
  },
  {
    ...
    description: 'Uma noite com sucessos, performances marcantes e uma experiência de teatro premium.',
  ...
  },
  {
    ...
    description: 'Três palcos, artistas convidados e uma programação de música eletrônica e indie.',
  ...
  },
  {
    ...
    description: 'Confronto decisivo do campeonato com torcida mista, setor premium e acesso integrado.',
...
export const MY_TICKETS: MyTicket[] = [
  {
    ...
    dateLabel: '22 ago · 20:00',
    venue: 'Arena Barueri',
    code: 'TKT-WKND-2401',
    status: 'valid',
    typeLabel: 'Pista Premium',
    cover: EVENTS[0].cover,
  },
  {
    id: 'ticket-2',
    eventTitle: 'Dune: Parte Três',
    dateLabel: '14 set · 19:30',
    venue: 'Cinepolis Paulista',
    code: 'TKT-DUNE-9031',
    status: 'used',
    typeLabel: 'Inteira',
...
export const ORGANIZER_EVENTS: OrganizerEvent[] = [
  { id: 'evt-1', title: 'The Weeknd', status: 'Publicado', sold: 980, capacity: 1400, dateShort: '22 ago' },
  { id: 'evt-2', title: 'Alexandre Pires', status: 'Publicado', sold: 640, capacity: 900, dateShort: '30 set' },
  { id: 'evt-3', title: 'Festival Tribe', status: 'Rascunho', sold: 190, capacity: 500, dateShort: '12 out' },
];

export const TEST_CODES: Array<{ code: string; status: 'valid' | 'used' | 'invalid' }> = [
